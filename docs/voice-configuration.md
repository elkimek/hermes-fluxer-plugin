...
| `barge_in.min_ms` | `FLUXER_VOICE_BARGE_IN_MIN_MS` | `180` | Voiced duration required before interrupting; uses `barge_in.window_ms` when set. | Lower for faster stop; raise to avoid false triggers. |
